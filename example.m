...
spec_saw = Pred_Green(lambda, h*2, 1, M0, rho0, obs_location, freq,c0,n,m,1);
spec_base = Pred_Green(0.04, 1e-6, 1, M0, rho0, obs_location, freq,c0,n,m,1);

%% Figure
Line_color = [248 118 109;
    190	190	190]/256;
fig_phi=figure;
