...
function PHI_seq = Pred_Green(lambda, epsilon, c, M0, rho0, obs_location, freq,c0,n,m)

% nodimensionalize the input parameters using lambda and c0
h      = epsilon/2/lambda;
c      = c/lambda;
beta   = sqrt(1-M0^2);
U_c    = M0*0.7;        % convection velocity Uc
...
result_g_n  = g_n(n_mat,j_mat,k_1_mat,k_2_mat,h,c,M0,omega_mat,x_1,x_2,x_3);
...
% $g^{(0,j)}$ in the paper
result_g_01 = g_01(n0_mat,j_mat,k_1_mat,k_2_mat,h,c,M0,omega_mat,x_1,x_2,x_3);
result_g_02 = g_02(n0_mat,j_mat,k_1_mat,k_2_mat,h,c,M0,omega_mat,x_1,x_2,x_3);
result_g_03 = g_03(n0_mat,j_mat,k_1_mat,k_2_mat,h,c,M0,omega_mat,x_1,x_2,x_3);
result_g_04 = g_04(n0_mat,j_mat,k_1_mat,k_2_mat,h,c,M0,omega_mat,x_1,x_2,x_3);

% effects of the reflected wave and the incident wave
result_g_r  = g_r(n0_mat,j_mat,k_1_mat,k_2_mat,h,c,M0,omega_mat,x_1,x_2,x_3);  % Effects of the reflected wave
result_g_in = g_in(n0_mat,j_mat,k_1_mat,k_2_mat,h,c,M0,omega_mat,x_1,x_2,x_3); % Effects of the incident wave
...
Pi_value    = Pi_Chase(c*lambda,omega_mat*c0/lambda,M0,k_2_mat/lambda)*2*pi*c0*2*pi/(rho0^2*v_star^4*C_m).*(omega_mat*x_3/(4*pi*S_0^2)).^2;
